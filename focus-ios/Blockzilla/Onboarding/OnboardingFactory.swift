...
fileprivate extension String {
    ...
    static let onboardingTitleFormat = NSLocalizedString("Onboarding.Title", value: "Welcome to %@!", comment: "Text for a label that indicates the title for onboarding screen. Placeholder can be (Focus or Klar).")
